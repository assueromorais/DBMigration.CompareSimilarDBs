 ...
 CREATE PROCEDURE [dbo].[spComboPessoas2] 
...
DECLARE @IdPessoa int, @NomePessoa varchar(60), @CGCCPF varchar(14), 
	@CGCCPFFORMATADO varchar(18), @Contador int, @Dado2 varchar(60), 
	@Habilitado int, @E_PessoaJuridica bit,@Ativo bit

IF @Id <> NULL
BEGIN
	SELECT IdPessoa, CNPJCPF, Nome, Habilitado, E_PessoaJuridica,Ativo
	FROM Pessoas
	WHERE IdPessoa = @Id
	ORDER BY Nome
END
...
INTO @IdPessoa, @CGCCPF, @NomePessoa, @Habilitado, @E_PessoaJuridica,@Ativo
