CREATE PROCEDURE [dbo].[sp_converte_log_0] 
	@datainicio DATETIME, 
...
AS 
	...
	BEGIN 
	    ...
	    IF @Erro = 0  AND @Id_Tipo_Operacao = 1 
	    BEGIN 
	    ...
	    IF @Erro = 0 AND @Id_Tipo_Operacao = 3 
	    BEGIN 
	        SET @tam_conteudo = LEN(@Conteudo) 
	        SET @i = 1 
	        SET @posicaoInicial = 1 
	        ...
	        BEGIN 
	            ...
	            BEGIN 
	                ...
	                --SELECT  @Id_log, @Id_Campo_log, @Chave_Registro, @Valor_Campo_Ant  
