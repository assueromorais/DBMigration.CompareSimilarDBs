/* PCS André - 21/09/2009 */
/*Italo - 14/06/2010 - OC 62925*/
/*Gaspar / Kleber - 20/08/2010 - OC 66904*/


create PROCEDURE [dbo].[Sp_CalculaOrcamentoPCS]       
@Exercicio int,        
...
CREATE TABLE #TABTEMP1        
 ...
 SELECT 
	   ...
	   cp.NomePersonalizado WHERE pc.Grupo IN (3, 4, 5, 6) AND u.IdUsuario = @IdUsuario  
 UNION 
