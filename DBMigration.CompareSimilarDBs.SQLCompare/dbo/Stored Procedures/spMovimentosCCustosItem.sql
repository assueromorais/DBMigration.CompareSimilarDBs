...
CREATE PROCEDURE [dbo].[spMovimentosCCustosItem]  
...
BEGIN  
 ...
 SELECT SubItens.IdSubItem,  
        ...
        MovimentacoesItens.DataMovimentacao,  
 ...
 WHERE  DataMovimentacao >= @DataInicial  
        ...
        AND (  
                (@IdItemEscolhido = 0)  
                OR (Itens.IdItem = @IdItemEscolhido)  
            )   
            --GROUP BY SubItens.IdSubItem, Itens.CodigoItem, SubItens.NomeSubItem, CentroCustos.CodigoCentroCusto, CentroCustos.NomeCentroCusto,grupositens.NomeGrupoItem, MovimentacoesItens.DataMovimentacao, MovimentacoesItens.Qtd, #Referencia.ValorReferencia    /*Kleber - 30/06/2010 - OC 64721*/  
 ORDER BY  
        CodigoCentroCusto,  
        MovimentacoesItens.DataMovimentacao    
