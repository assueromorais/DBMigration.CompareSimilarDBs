CREATE TABLE [dbo].[DominiosSiscafwFiscalizacoes] (
    [IdSistema]        INT           NULL,
...
GO
CREATE TRIGGER [TrgLog_DominiosSiscafwFiscalizacoes] ON [Implanta_CRPAM].[dbo].[DominiosSiscafwFiscalizacoes] 
...
SET @Conteudo = Null 
SET @Conteudo2 = Null 
SET @TableName = 'DominiosSiscafwFiscalizacoes'
IF   ( @CountI   =   1  )  AND 
     ( @CountD   =   1  ) 
BEGIN 
