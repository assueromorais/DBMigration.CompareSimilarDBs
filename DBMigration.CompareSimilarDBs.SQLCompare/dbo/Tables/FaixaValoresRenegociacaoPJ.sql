CREATE TABLE [dbo].[FaixaValoresRenegociacaoPJ] (
...
GO
CREATE TRIGGER [TrgLog_FaixaValoresRenegociacaoPJ] ON [Implanta_CRPAM].[dbo].[FaixaValoresRenegociacaoPJ] 
...
SET @Conteudo = Null 
SET @Conteudo2 = Null 
SET @TableName = 'FaixaValoresRenegociacaoPJ'
IF   ( @CountI   =   1  )  AND 
     ( @CountD   =   1  ) 
BEGIN 
