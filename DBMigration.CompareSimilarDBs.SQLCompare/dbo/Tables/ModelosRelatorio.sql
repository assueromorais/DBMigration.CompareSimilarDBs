CREATE TABLE [dbo].[ModelosRelatorio] (
    [ID]        INT          IDENTITY (1, 1) NOT NULL,
    [Descricao] VARCHAR (40) NOT NULL,
    [Modelo]    IMAGE        NULL,
    CONSTRAINT [PK_ModelosRelatorio] PRIMARY KEY CLUSTERED ([ID] ASC)
);


GO
CREATE TRIGGER [TrgLog_ModelosRelatorio] ON [Implanta_CRPAM].[dbo].[ModelosRelatorio] 
...
SET @Conteudo = Null 
SET @Conteudo2 = Null 
SET @TableName = 'ModelosRelatorio'
IF   ( @CountI   =   1  )  AND 
     ( @CountD   =   1  ) 
BEGIN 
