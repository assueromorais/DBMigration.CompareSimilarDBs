CREATE TABLE [dbo].[Param_Ren_DebitosPJ] (
...
GO
CREATE TRIGGER [TrgLog_Param_Ren_DebitosPJ] ON [Implanta_CRPAM].[dbo].[Param_Ren_DebitosPJ] 
...
SET @Conteudo = Null 
SET @Conteudo2 = Null 
SET @TableName = 'Param_Ren_DebitosPJ'
IF   ( @CountI   =   1  )  AND 
     ( @CountD   =   1  ) 
BEGIN 
