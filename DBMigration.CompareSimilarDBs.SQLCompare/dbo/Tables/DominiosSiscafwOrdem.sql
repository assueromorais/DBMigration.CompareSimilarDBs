CREATE TABLE [dbo].[DominiosSiscafwOrdem] (
    [IdSistema]        INT           NULL,
...
GO
CREATE TRIGGER [TrgLog_DominiosSiscafwOrdem] ON [Implanta_CRPAM].[dbo].[DominiosSiscafwOrdem] 
...
SET @Conteudo = Null 
SET @Conteudo2 = Null 
SET @TableName = 'DominiosSiscafwOrdem'
IF   ( @CountI   =   1  )  AND 
     ( @CountD   =   1  ) 
BEGIN 
