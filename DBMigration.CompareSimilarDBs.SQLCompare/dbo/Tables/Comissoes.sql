CREATE TABLE [dbo].[Comissoes] (
    [IdComissao]     INT          IDENTITY (1, 1) NOT NULL,
    [Descricao]      VARCHAR (50) NOT NULL,
    [MotivoFormacao] TEXT         NULL,
    CONSTRAINT [PK_Comissoes] PRIMARY KEY CLUSTERED ([IdComissao] ASC)
);


GO
CREATE TRIGGER [TrgLog_Comissoes] ON [Implanta_CRPAM].[dbo].[Comissoes] 
